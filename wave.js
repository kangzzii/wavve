...
function start(){
    ...
    $(".dot").eq(0).css("background-color","#133df6")
...
function dot_slide(){
    if(now==1){
        ...
        $(".dot").eq(1).css("background-color","#133df6")
        ...
        $(".dot").eq(2).css("background-color","#133df6")
        ...
        if(now==3){
            ...
            $(".dot").eq(3).css("background-color","#133df6")
        ...
        $(".dot").eq(4).css("background-color","#133df6")
        ...
        if(now==5){
            ...
            $(".dot").eq(5).css("background-color","#133df6")
        ...
        $(".dot").eq(6).css("background-color","#133df6")
        ...
        if(now==7){
            ...
            $(".dot").eq(7).css("background-color","#133df6")
